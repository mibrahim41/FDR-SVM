...
for i = 1:num_exp
    filename = sprintf('FDR-SVM_Park_%d.mat',i);
    load(filename)
...
[p_fedSGD, h_fedSGD, stats_fedSGD] = signrank(acc_fedSGD_vec,acc_SM_vec,'tail','left');
[p_fedAvg, h_fedAvg, stats_fedAvg] = signrank(acc_fedAvg_vec, acc_SM_vec,'tail','left');
[p_fedProx, h_fedProx, stats_fedProx] = signrank(acc_fedProx_vec, acc_SM_vec,'tail','left');
[p_fedDRO_kl, h_fedDRO_kl, stats_fedDRO_kl] = signrank(acc_fedDRO_kl_vec, acc_SM_vec,'tail','left');