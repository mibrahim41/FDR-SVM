...
def save_exp_file(batch,P,G,N_train,N_test,weights_train,weights_test,class_sep,perc_g_vec,num_exp,max_iter_vec,
    ...
    filename = 'FDR-SVM_sensitivity_nom_'+str(int(timeit.default_timer()))+batch+'.mat'
...
for i in range(num_exp):
    ...
    central_set, client_sets, test_set, central_set_norm, client_sets_norm, test_set_norm, Ng_vec = gen_data(imb_type='0', 
                                                                                                             perc_wrong_y=0)
